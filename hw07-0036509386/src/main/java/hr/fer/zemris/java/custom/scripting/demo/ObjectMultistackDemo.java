...
/**
 * A class used to demonstrate {@code ObjectMultistack}.
 *
 * @author marcupic
 */
...
public class ObjectMultistackDemo {
    ...
    public static void main(String[] args) {
        ...
        multistack.peek("year").add("5"); System.out.println("Current value for year: "
                + multistack.peek("year").getValue());
        ...
        multistack.peek("year").add(5.0); System.out.println("Current value for year: "
                + multistack.peek("year").getValue());
    }
}
